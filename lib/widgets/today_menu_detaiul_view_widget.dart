...
import '../providers/today_menu_detail_provider.dart';
import '../providers/vendors_list_home_provider.dart';
import 'restuarant_module_widget/restaurant_similar_items_widget.dart';

class TodayMenuDetailViewWidget extends ConsumerStatefulWidget {
  final String productID;
  const TodayMenuDetailViewWidget({super.key, required this.productID});

  @override
  ConsumerState<TodayMenuDetailViewWidget> createState() =>
      _TodayMenuDetailViewWidgetState();
}

class _TodayMenuDetailViewWidgetState
    extends ConsumerState<TodayMenuDetailViewWidget> {
  ...
  StreamSubscription<num>? _quantitySubscription;
  ...
  void _initializeAvailableQuantity() {
    _quantitySubscription?.cancel(); // Cancel any existing subscription

    _quantitySubscription = ref
        .read(cartStorageRestaurantProviderProvider.notifier)
        .getProductQuantityRestaurantStream(widget.productID)
        .distinct() // Only update when value actually changes
        .listen((available) {
      if (mounted) {
        setState(() {
  ...
  // Future<void> _initializeAvailableQuantity() async {
  //   final available = await ref
  //       .read(cartStorageRestaurantProviderProvider.notifier)
  //       .getProductQuantityRestaurant(widget.productID);
  //
  //   if (mounted) {
  //     setState(() {
  //       availableQuantity = available;
  //       // Always start with 1 if available, otherwise 0
  //       quantity = available > 0 ? 1 : 0;
  //     });
  //   }
  // }
  ...
  @override
  void didUpdateWidget(covariant TodayMenuDetailViewWidget oldWidget) {
    if (mounted) {
  ...
  Widget build(BuildContext context) {
    var prodQuantity = ref
        .watch(cartStorageRestaurantProviderProvider.notifier)
        .getProductQuantityRestaurant(widget.productID);

    final productsModel =
        ref.watch(todayMenuDetailProviderProvider(widget.productID)).valueOrNull;
...
//////////////// Restaurant Providers ////////////////////////////
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
          ...
          Column(
            children: [
              if (productsModel == null) const Gap(50),
              productsModel == null
                  ? Padding(
                ...
                child: Column(
                  ...
                  children: [
                    const Gap(20),
                    if (productsModel.module == 'Ecommerce')
                      Row(
                        children: [
                          const Gap(10),
                          InkWell(
                          ...
                          InkWell(
                            onTap: () {
                              context.go(
                                  '/ecommerce/products/${productsModel.category}');
                            },
                            child: Text(
                          ...
                          InkWell(
                            onTap: () {
                              context.go(
                                  '/ecommerce/collection/${productsModel.collection}');
                            },
                            child: Text(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      Row(
                                        children: [
                                          Text(
                                            '$currency${productsModel.unitPrice1!.toDouble().toStringAsFixed(2)}',
                                            style: const TextStyle(
                                                fontSize: 20,
                                                fontFamily: 'Nunito',
                                                fontWeight:
                                          ...
                                          const Gap(5),
                                          Text(
                                            '$currency${productsModel.unitOldPrice1!.toDouble().toStringAsFixed(2)}',
                                            style: const TextStyle(
                                                fontSize: 18,
                                                fontFamily: 'Nunito',
                                                color: Colors.grey,
                                      ...
                                      Text(
                                        ...
                                        style:
                                        const TextStyle(fontSize: 12,fontFamily: 'Nunito'),
                                      ),
                                      const Gap(5),
                                      Row(
                                        children: [
                                      ...
                                      Container(
                                        ...
                                        child: RadioListTile(
                                            title: Text(
                                              productsModel.unitname1,style: TextStyle(fontFamily: 'Nunito'),),
                                            secondary: RichText(
                                        ...
                                        Container(
                                          decoration: BoxDecoration(
                                              ...
                                              border: Border.all(
                                                  ...
                                                  width: 0.5)),
                                          child: RadioListTile(
                                              title: Text(productsModel
                                                  .unitname2,style: TextStyle(fontFamily: 'Nunito'),),
                                              secondary: RichText(
                                                textAlign:
                                                TextAlign.start,
                                                text: TextSpan(
                                      ...
                                      if (productsModel
                                        ...
                                        Container(
                                          ...
                                          child: RadioListTile(
                                              title: Text(productsModel
                                                  .unitname3,style: TextStyle(fontFamily: 'Nunito'),),
                                              secondary: RichText(
                                                textAlign:
                                                TextAlign.start,
                                                text: TextSpan(
                                      ...
                                      if (productsModel
                                        ...
                                        Container(
                                          ...
                                          child: RadioListTile(
                                              title: Text(productsModel
                                                  .unitname4,style: TextStyle(fontFamily: 'Nunito'),),
                                              secondary: RichText(
                                                textAlign:
                                                TextAlign.start,
                                                text: TextSpan(
                                      ...
                                      if (productsModel
                                        ...
                                        Container(
                                          ...
                                          child: RadioListTile(
                                              title: Text(productsModel
                                                  .unitname5,style: TextStyle(fontFamily: 'Nunito'),),
                                              secondary: RichText(
                                                textAlign:
                                                TextAlign.start,
                                                text: TextSpan(
                                      ...
                                      if (productsModel
                                        ...
                                        Container(
                                          ...
                                          child: RadioListTile(
                                              title: Text(productsModel
                                                  .unitname6,style: TextStyle(fontFamily: 'Nunito'),),
                                              secondary: RichText(
                                                textAlign:
                                                TextAlign.start,
                                                text: TextSpan(
                                      ...
                                      if (productsModel
                                        ...
                                        Container(
                                          ...
                                          child: RadioListTile(
                                              title: Text(productsModel
                                                  .unitname7,style: TextStyle(fontFamily: 'Nunito'),),
                                              secondary: RichText(
                                                textAlign:
                                                TextAlign.start,
                                                text: TextSpan(
                                                  ...
                                                  child: Row(
                                                      ...
                                                      children: [
                                                        ...
                                                        Row(
                                                            mainAxisAlignment: MainAxisAlignment.start,
                                                            children: [
                                                              Text('+$currency${Formatter().converter(productsModel.extraPrice1!.toDouble())}', style: TextStyle(fontSize: 12.r, fontFamily: 'Nunito',fontWeight: FontWeight.bold)),
                                                  ...
                                                  child: Row(
                                                      ...
                                                      children: [
                                                        ...
                                                        Row(
                                                            mainAxisAlignment: MainAxisAlignment.start,
                                                            children: [
                                                              Text('+$currency${Formatter().converter(productsModel.extraPrice2!.toDouble())}', style: TextStyle(fontSize: 12.r,fontFamily: 'Nunito', fontWeight: FontWeight.bold)),
                                                              const SizedBox(width: 5),
                                                            ])
                                                      ]),
                                                ),
                                                  ...
                                                  child: Row(
                                                      ...
                                                      children: [
                                                        ...
                                                        Row(
                                                            mainAxisAlignment: MainAxisAlignment.start,
                                                            children: [
                                                              Text('+$currency${Formatter().converter(productsModel.extraPrice3!.toDouble())}', style: TextStyle(fontSize: 12.r,fontFamily: 'Nunito', fontWeight: FontWeight.bold)),
                                                              const SizedBox(width: 5),
                                                            ])
                                                      ]),
                                                ),
                                                  ...
                                                  child: Row(
                                                      ...
                                                      children: [
                                                        ...
                                                        Row(
                                                            mainAxisAlignment: MainAxisAlignment.start,
                                                            children: [
                                                              Text('+$currency${Formatter().converter(productsModel.extraPrice4!.toDouble())}', style: TextStyle(fontSize: 12.r,fontFamily: 'Nunito', fontWeight: FontWeight.bold)),
                                                              const SizedBox(width: 5),
                                                            ])
                                                      ]),
                                                ),
                                                  ...
                                                  child: Row(
                                                      ...
                                                      children: [
                                                        ...
                                                        Row(
                                                            mainAxisAlignment: MainAxisAlignment.start,
                                                            children: [
                                                              Text('+$currency${Formatter().converter(productsModel.extraPrice5!.toDouble())}', style: TextStyle(fontSize: 12.r,fontFamily: 'Nunito', fontWeight: FontWeight.bold)),
                                                              const SizedBox(width: 5),
                                                            ])
                                                      ]),
                                                ),
                                      ...
                                      Row(
                                        children: [
                                                    ...
                                                    child: Row(
                                                      children: [
                                                        ...
                                                        Expanded(
                                                          ...
                                                          child: InkWell(
                                                            onTap: () {
                                                              if (quantity >= availableQuantity) { // Use availableQuantity here
                                                                Fluttertoast.showToast(
                                          ...
                                          Expanded(
                                            flex : 1,
                                            child:Text('Remaining quantity : ${availableQuantity}',style:TextStyle(fontSize: 14,fontFamily: 'Nunito' ,),),
                                          )
                                        ],
                                      ),
                                      const Gap(20),
                                        ...
                                        Row(
                                          ...
                                          children: [
                                            Expanded(
                                              ...
                                              child: ElevatedButton(
                                                  ...
                                                  onPressed: () {
                                                    ...
                                                    if (availableQuantity <= 0) { // Directly check availableQuantity
                                                      Fluttertoast.showToast(
                                                          msg: "Sold out",
                                                          toastLength: Toast.LENGTH_SHORT,
                                                          gravity: ToastGravity.TOP,
                                                    ...
                                                    if (productsModel.quantity! <= 0) { // Optional: Original check as fallback
                                                      Fluttertoast.showToast(
                                                          msg: "Product out od stock".tr(),
                                                          toastLength: Toast.LENGTH_SHORT,
                                                          gravity: ToastGravity.TOP,
                                                          timeInSecForIosWeb: 3,
                                                          backgroundColor: const Color(0xFFFFD581),
                                                    ...
                                                    if (cartStorageDataRestaurant.any((e) =>
                                                    e.productID ==
                                                        productsModel
                                                            .productID &&
                                                        e.selected ==
                                                      ...
                                                      cartStorageRestaurant.saveToCartRestaurant(
                                                          CartModel(
                                                              module: productsModel.module,
                                                              isPrescription: productsModel.isPrescription,
                                                              ...
                                                              totalNumberOfUserRating: productsModel.totalNumberOfUserRating!,
                                                              totalRating: productsModel.totalRating!,
                                                              productID: productsModel.productID,
                                                              price: selectedPrice == 0 ? (productsModel.unitPrice1! * quantity) + getSelectedExtra1(productsModel.extraPrice1!) + getSelectedExtra2(productsModel.extraPrice2!) + getSelectedExtra3(productsModel.extraPrice3!) + getSelectedExtra4(productsModel.extraPrice4!) + getSelectedExtra5(productsModel.extraPrice5!) : (selectedPrice * quantity) + getSelectedExtra1(productsModel.extraPrice1!) + getSelectedExtra2(productsModel.extraPrice2!) + getSelectedExtra3(productsModel.extraPrice3!) + getSelectedExtra4(productsModel.extraPrice4!) + getSelectedExtra5(productsModel.extraPrice5!),
                                            ...
                                            Expanded(
                                              ...
                                              child: Row(
                                                children: [
                                                  favoriteStorageDataRestaurant.any((e) =>
                                                  e.productID ==
                                                      productsModel
                                                          .productID) ==
                                                      false
                                                      ? InkWell(
                                                    onTap: () {
                                                      favoriteStorageRestaurant.saveToFavoriteRestaurant(
                                                          CartModel(
                                                              module: productsModel.module,
                                                              vendorName: productsModel.vendorName,
                                                              price: productsModel.unitPrice1!,
                                                              selectedPrice: productsModel.unitPrice1!,
                                                              selected: productsModel.unitname1,
                                                              returnDuration: productsModel.returnDuration!,
                                                              totalRating: productsModel.totalRating!,
                                                              quantity: 1,
                                                              totalNumberOfUserRating: productsModel.totalNumberOfUserRating!,
                                                    ...
                                                    Container(
                                                      ...
                                                      : InkWell(
                                                    onTap: () {
                                                      favoriteStorageRestaurant.removeFromFavoriteRestaurant(
                                                          productsModel
                                                              .productID,
                                                          context);
                                                    },
                    ...
                    child: DefaultTabController(
                      ...
                      child: Column(
                        children: [
                          ...
                          Column(
                            children: [
                              // if (productsModel.description.isNotEmpty)
                              if (selectedTab == 1)
                                SizedBox(
                                  width: double.infinity,
                                  child: Padding(
                              ...
                              // if (!productsModel.returnDuration.isNaN)
                              if (selectedTab == 2)
                                SizedBox(
                                  width: double.infinity,
                                  child: Padding(
                                      ...
                                      child: Text(productsModel
                                          ...
                                          0
                                          ? 'No return policy'
                                          : '${productsModel.returnDuration} Day Return Guarantee',style: TextStyle(fontFamily: 'Nunito'),)),
                                ),
                              // if (productsModel != null)
                              if (selectedTab == 3)
                                Padding(
              ...
              if (productsModel != null) const Gap(20),
              if (productsModel != null)
                Padding(
                  padding: const EdgeInsets.only(left: 50, right: 50),
                  child: Row(
              ...
              if (productsModel != null)
                // Padding(
                //   padding: const EdgeInsets.only(left: 50, right: 50),
                //   child: RestaurantSimilarItemsWidget(
                //     productID: productsModel.productID,
                //     category: productsModel.category,
                //   ),
                // ),
                              ...
                              children: [
                                ...
                                if (productsModel.unitname5.isNotEmpty)
                                  Container(
                                    ...
                                    child: RadioListTile(
                                        title:
                                        Text(productsModel.unitname5,style: TextStyle(fontFamily: 'Nunito'),),
                                        secondary: RichText(
                                          text: TextSpan(
                                            children: [
                                              TextSpan(
                                                  ...
                                                  Row(
                                                      ...
                                                      children: [
                                                        Text(
                                                            ...
                                                            style: TextStyle(fontSize: 12.r, fontWeight: FontWeight.bold,fontFamily: 'Nunito')),
                                                        const SizedBox(
                                                            width: 5),
                                                      ])
                                                ]),
                                ...
                                Row(
                                  children: [
                                                  ...
                                                  Expanded(
                                                    ...
                                                    child: InkWell(
                                                      onTap: () {
                                                        if (quantity <= 1) {
                                                          Fluttertoast.showToast(
                                                              msg: "Ypu can't go below this quantity",
                                                              toastLength: Toast.LENGTH_SHORT,
                                                              gravity: ToastGravity.TOP,
                                                              timeInSecForIosWeb: 3,
                                                              backgroundColor: const Color(0xFFFFD581),
                                    ...
                                    Expanded(
                                      flex : 1,
                                      child:Text('Remaining quantity : ${availableQuantity}',style:TextStyle(fontSize: 12,fontFamily: 'Nunito' ,),),
                                    )
                                  ],
                                ),
                                const Gap(20),
                ...
                child: Row(
                  children: [
                    const Text(
                      'Similar items you may like',
                      style:
                      TextStyle(fontWeight: FontWeight.bold, fontSize: 17,fontFamily: 'Nunito'),
                    ).tr(),
                  ],
                ),
              ),
