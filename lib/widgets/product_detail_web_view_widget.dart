...
import 'package:user_web/providers/product_detail_provider.dart';
...
class ProductDetailWebViewWidget extends ConsumerStatefulWidget {
  final String productID;
  const ProductDetailWebViewWidget({super.key, required this.productID});

  @override
  ConsumerState<ProductDetailWebViewWidget> createState() =>
      _ProductDetailWebViewWidgetState();
}

class _ProductDetailWebViewWidgetState
    extends ConsumerState<ProductDetailWebViewWidget> {
  ...
  void _initializeAvailableQuantity() {
    ...
    _quantitySubscription = ref
        ...
        .getGroceryProductQuantityStream(widget.productID)
  ...
  Widget build(BuildContext context) {
    ...
    final isGroceryModule = productsModel?.module == 'Grocery';
    print('Product module from model: ${productsModel?.module}');
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            ...
                                            Row(
                                              children: [
                                                Text(
                                                  '$currency${productsModel.unitPrice1!.toStringAsFixed(2)}',
                                                  style: const TextStyle(
                                                      fontSize: 20,
                                                      fontFamily: 'Nunito',
                                                      fontWeight:
                                                ...
                                                const Gap(5),
                                                Text(
                                                  '$currency${productsModel.unitOldPrice1!.toStringAsFixed(2)}',
                                                  style: const TextStyle(
                                                      fontSize: 18,
                                                      fontFamily: 'Nunito',
                                                      color: Colors.grey,
