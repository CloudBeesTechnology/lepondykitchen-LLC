...
class RestaurantCatsMobileViewWidget extends StatefulWidget {
  const RestaurantCatsMobileViewWidget({
    super.key,
  });

  @override
  State<RestaurantCatsMobileViewWidget> createState() =>
      _RestaurantCatsMobileViewWidgetState();
}

class _RestaurantCatsMobileViewWidgetState
    extends State<RestaurantCatsMobileViewWidget> {
                ...
                itemBuilder: (BuildContext context, int index) {
                  ...
                  return index == 7
                      ...
                      : InkWell(
                          onTap: () {
                            context.go(
                                '/restaurant/products/${categoriesModel.category}');
                          },
                          child: Stack(
                            children: [
                              CatImageWidget(
