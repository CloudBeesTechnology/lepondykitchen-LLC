...
class RestaurantProductWidgetMain extends ConsumerStatefulWidget {
  final ProductsModel productsModel;
  final int index;
  const RestaurantProductWidgetMain(
      {super.key, required this.productsModel, required this.index});

  @override
  ConsumerState<RestaurantProductWidgetMain> createState() =>
      _RestaurantProductWidgetMainState();
}

class _RestaurantProductWidgetMainState
    extends ConsumerState<RestaurantProductWidgetMain> {
  var logger = Logger();
