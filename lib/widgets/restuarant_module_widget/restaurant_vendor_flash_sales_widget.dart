...
class RestaurantVendorFlashSalesWidget extends ConsumerStatefulWidget {
  final String vendorID;
  const RestaurantVendorFlashSalesWidget({
    super.key,
    required this.vendorID,
  });

  @override
  ConsumerState<RestaurantVendorFlashSalesWidget> createState() =>
      _RestaurantVendorFlashSalesWidgetState();
}

class _RestaurantVendorFlashSalesWidgetState
    extends ConsumerState<RestaurantVendorFlashSalesWidget> {
  bool reverse = false;
  @override
  void initState() {
    super.initState();
  ...
  Widget build(BuildContext context) {
    ...
    final hotDeals = widget.vendorID.isEmpty
        ? null
        : ref
            .watch(flashSalesStreamRestaurantByVendorProvider(widget.vendorID));
                    ...
                    child: Column(
                      children: [
                        // MediaQuery.of(context).size.width >= 1100
                             timer.when(
                          data: (v) {
                            print("Fetched Flash Sales Time: $v");
