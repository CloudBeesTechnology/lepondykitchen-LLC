...
class _ShareToSocialsState extends State<ShareToSocials> {
  void shareToFacebook() async {
    ...
    final facebookShareUrl = 'https://www.facebook.com/profile.php?id=61575876041431';
  ...
  void shareToInstagram() async {
    ...
    if (await canLaunchUrl(Uri.parse(instagramUrl))) {
      ...
      await launchUrl(Uri.parse(
          'https://www.instagram.com/lepondycloudkitchen'));
    } else {
        ...
        Row(
          children: [
            ...
            InkWell(
                ...
                child: Image.asset('assets/image/insta logo.png', scale: 58)),
            const Gap(10),
            InkWell(
                onTap: () {
                  launchWhatsApp();
