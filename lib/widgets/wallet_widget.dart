...
class _WalletWidgetState extends State<WalletWidget> {
  ...
  getRazorpayStatus() {
    FirebaseFirestore.instance
        ...
        .then((value) {
      if (value.exists) {
        var razorpayData = value.data()?['Razorpay'];

        // Convert to boolean safely
        bool isEnabled = razorpayData is bool
            ? razorpayData
            : (razorpayData is String && razorpayData.toLowerCase() == 'true');

        setState(() {
          enableRazorpay = isEnabled;
        });
      } else {
        print("No payment system configured.");
        setState(() {
