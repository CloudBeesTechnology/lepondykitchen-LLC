...
class OtpPage2 extends StatefulWidget {
  ...
  @override
  State<OtpPage2> createState() => _OtpPageState();
}

class _OtpPageState extends State<OtpPage2> {
  ...
  Future<void> verifyOtpAndNavigate() async {
    ...
    if (smsCode.length != 6) {
      showErrorDialog(context, "Enter a valid 6 digit OTP");
      return;
    }
    ...
    try {
      ...
      await showAlertsDialog(context, "Logged in successfully");
      ...
      if (context.mounted) context.loaderOverlay.hide();
      showErrorDialog(context, 'Invalid or expired OTP');
    }
  }
